...
const Sidebar = () => {
  return (
    <div className="flex flex-col absolute left-0 top-0 bottom-0 p-2 mx-2">
      ...
      <hr />
      <div className="p-2">
        <h3 className="py-2 font-medium">Explore</h3>
        <ul>
          <li className="flex py-2">
            <div className="mr-6">
              <svg
      ...
      <hr />
      <div className="p-2">
        <h3 className="py-2 font-medium">More from MyTube</h3>
        <ul>
          <li className="flex py-2">
            <img
              className="h-8 mr-5"
          ...
          <li className="flex py-2">
            <img
              className="h-8 mr-5"
              alt="youtube-music"
              src="https://static.vecteezy.com/system/resources/previews/017/395/384/non_2x/youtube-music-icon-free-png.png"
            />
            <span>MyTube Music</span>
          </li>
          <li className="flex py-2">
            <img
              className="h-8 mr-5"
              alt="youtube-kids"
              src="https://i.pinimg.com/originals/41/e8/20/41e82046cd52130a111049ea560cfbda.png"
            />
            <span>MyTube Kids</span>
          </li>
        </ul>
      </div>
      <hr />
